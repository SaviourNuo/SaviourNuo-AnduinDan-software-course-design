...
def single_predict(img_path):
    ...
    #img_path = os.path.join(data_root,"network_spider","getImg2_test")  # "../tulip.jpg"
    assert os.path.exists(img_path), "file: '{}' dose not exist.".format(img_path)
    #img = Image.open(os.path.join(img_path,"app-download.jpg")).convert('RGB')
    ...
    # load model weights
    weights_path = "./neural_networks/weights_list/resNet34.pth"
